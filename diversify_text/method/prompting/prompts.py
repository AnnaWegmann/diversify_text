"""Prompt bank for the prompting diversification method."""

from __future__ import annotations

# -- Zero-shot style transfer templates ---------------------------------------
# These are prompts taken from other work. They describe the wanted styles in the prompt.
# Use only [DOCUMENT SEGMENT] placeholders.
...
DEFAULT_PROMPT_BANK: dict[str, str] = {
    ...
    # Original paper had 5 modifications; we added 6. (emojis) and 7. (casing).
    "humanize_llm-as-coauthor": (
        ...
        "(optional).\n"
        "6. Use emojis and emoticons, e.g., :-), -.-, \U0001f602, \u2764\ufe0f, etc. "
        "(optional).\n"
        "7. Vary the casing of words at the beginning of sentences (optional).\n"
        ...
        "Here is the text: [DOCUMENT SEGMENT]"
    ),
    # From: https://arxiv.org/abs/2401.05952 (Zhang et al., 2024)
