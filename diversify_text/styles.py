...
DEFAULT_STYLES: list[str] = [
    "informal_tinystyler",  # https://github.com/zacharyhorvitz/TinyStyler/blob/main/generation/target_styles/informal.txt
    "obama_tinystyler", # https://github.com/zacharyhorvitz/TinyStyler/blob/main/generation/target_styles/obama.txt
    "question_tinystyler", # https://github.com/zacharyhorvitz/TinyStyler/blob/main/generation/target_styles/question_followed_by_sentence.txt
    "formal_stel",
    "song_lyrics",
    # "transcript_of_video_audio",
    # "personal_blog", research_article, encyclopedia_article
